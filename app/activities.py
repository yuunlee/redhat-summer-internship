...
def update_graph(select_org):
    ...
    barchart = px.bar(data_frame=dframe_org, x="org", y="percentage", color="repo_name", text="repo_name")
    ...
    if clk_data is None:
        ...
        fig2 = go.Figure(
            data=[
                ...
                go.Bar(
                    x=dff2["yearmonth"], y=dff2["pull_request_increment"], name="Increase in PR", marker_color="lime"
                ),
                go.Bar(
                    x=dff2["yearmonth"],
                ...
                go.Bar(
                    x=dff2["yearmonth"], y=dff2["issue_increment"], name="Increase in issue", marker_color="lightsalmon"
                ),
                go.Bar(
                    x=dff2["yearmonth"], y=dff2["star_increment"], name="Increase in star", marker_color="aliceblue"
                ),
                go.Bar(x=dff2["yearmonth"], y=dff2["fork_increment"], name="Increase in fork", marker_color="cornsilk"),
            ]
        )
