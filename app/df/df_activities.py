...
dbschema = "augur_data"
engine = salc.create_engine(database_connection_string, connect_args={"options": "-csearch_path={}".format(dbschema)})
...
dframe["total"] = (
    dframe["star_increment"]
    + dframe["commit_increment"]
    + dframe["fork_increment"]
    + dframe["watches_increment"]
    + dframe["committer_increment"]
    + dframe["issue_increment"]
    + dframe["pull_request_increment"]
    + dframe["open_pull_request_increment"]
    + dframe["closed_pull_request_increment"]
    + dframe["merged_pull_request_increment"]
)
