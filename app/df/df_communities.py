...
sub_frame = df_pr_committers[
    ["rg_name", "repo_name", "yearmonth", "cmt_committer_name", "cntrb_company", "cntrb_location", "num_of_commit"]
]
table = pd.pivot_table(
    sub_frame,
    values="num_of_commit",
