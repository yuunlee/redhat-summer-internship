...
from app.activities import activities_layout
from app.communities import communities_layout
from app.performances import performances_layout
...
app.layout = dbc.Container(
    [
        dbc.Row(dbc.Col(html.H1("Org-repo Density Metrics", style={"textAlign": "center"}), width=12)),
...
@app.callback(Output("select_repo", "options"), Input("select_org", "value"))
