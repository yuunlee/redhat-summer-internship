...
def update_graph(select_org):
    ...
    piechart1 = px.pie(data_frame=pr_final, values="total", names="repo_name", hole=0.25)
    ...
    piechart2 = px.pie(data_frame=issue_final, values="total", names="repo_name", hole=0.25)
...
def update_side_graph1(hov_data, clk_data, slct_data, select_org):
    if clk_data is None:
        ...
        sub_piechart1 = go.Figure(
            ...
            layout=dict(title=dict(text="kubernetes")),
        )
